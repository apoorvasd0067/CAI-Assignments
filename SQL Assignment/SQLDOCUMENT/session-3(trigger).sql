...
BEGIN
	...
	select @EmployeeNumber = EmployeeNumber, @DateOfTransaction = TransactionDate,  @Amount = TotalAmount
	from deleted
	--SELECT * FROM deleted
	delete tblTransaction
	from tblTransaction as T
	where T.EmployeeNumber = @EmployeeNumber
	and T.TransactionDate = @DateOfTransaction
	and T.Amount = @Amount
END
...
insert into tblTransaction(TransactionID,Amount, TransactionDate, EmployeeNumber)
VALUES (7,123,'2015-07-11', 535)
